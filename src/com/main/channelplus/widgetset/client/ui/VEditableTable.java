package com.main.channelplus.widgetset.client.ui;
 ...
 */
public class VEditableTable extends Widget implements Paintable, ClickHandler {

	/** Set the CSS class name to allow styling. */
	public static final String CLASSNAME = "v-editabletable";
